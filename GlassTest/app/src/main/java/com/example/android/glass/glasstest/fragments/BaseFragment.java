...
import com.example.android.glass.glasstest.ManualActivity;
...
public abstract class BaseFragment extends Fragment implements OnSingleTapUpListener {
   ...
   * @param resultCode is a code set by the {@link com.example.android.glass.glasstest.menu.MenuActivity}
